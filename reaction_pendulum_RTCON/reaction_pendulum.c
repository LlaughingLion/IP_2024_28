 ...
 * C source code generated on : Mon Apr 29 16:21:19 2024
 *
...
void reaction_pendulum_initialize(void)
{
  ...
  rtmSetTFinal(reaction_pendulum_M, 400.0);
  ...
  /* External mode info */
  reaction_pendulum_M->Sizes.checksums[0] = (746252633U);
  reaction_pendulum_M->Sizes.checksums[1] = (1570923377U);
  reaction_pendulum_M->Sizes.checksums[2] = (3307528853U);
  reaction_pendulum_M->Sizes.checksums[3] = (2801605311U);
